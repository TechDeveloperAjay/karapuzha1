...
import { getHeroSlideById, updateHeroSlide } from "@/actions/hero";
...
export default function EditHeroSlidePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      alert("Error updating hero slide: " + result.error);
    }
  };
    ...
    <form onSubmit={handleSave} className="space-y-6 max-w-5xl mx-auto pb-16">
      <div className="flex items-center gap-3">
        ...
        <PageHeader 
          ...
          description="Update slide caption titles, description text, sorting index, or hero banner images."
        />
      </div>
