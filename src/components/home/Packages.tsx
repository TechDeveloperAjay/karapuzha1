  ...
  return (
    <section className="py-20 bg-white dark:bg-[#0b0f14] transition-colors duration-300">
      <div className="container mx-auto px-6">
        ...
        {featured && (
          <div className="mb-8">
            <div className="group relative overflow-hidden rounded-[28px] h-[420px] shadow-[0_20px_60px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute top-6 left-6">
                <span className="px-4 py-2 rounded-full bg-white/90 dark:bg-black/60 backdrop-blur-sm text-[#8AA05A] font-semibold text-sm shadow-lg">
                  {featured.distance}
                </span>
              </div>
              ...
              <div className="absolute bottom-8 left-8 max-w-xl text-white">
                ...
                <p className="text-base md:text-lg text-white/90 leading-7">
            ...
            >
              <div className="relative h-[220px] overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1.5 rounded-full bg-white/90 dark:bg-black/60 backdrop-blur-sm text-[#8AA05A] text-xs font-semibold shadow-md">
                    {item.distance}
                  </span>
                </div>
              ...
              <div className="p-6">
                ...
                <h3 className="text-2xl font-serif text-[#1f2937] dark:text-white mb-3">
                  {item.title}
                </h3>
